...
<p>You can download the codelab project from: <a href="https://github.com/huaweicodelabs/CloudStorage/tree/master/Cloud-Storage-CodeLab" target="_blank">https://github.com/huaweicodelabs/CloudStorage/tree/master/Cloud-Storage-CodeLab</a></p>

<h2><strong>Creating a Project</strong></h2>
<p><strong>Step 1</strong>: Start Android Studio.</p>
<p><strong>Step 2</strong>: Choose <strong>File</strong> &gt; <strong>Open</strong>, go to the directory where the sample project is decompressed, and click <strong>OK</strong>.<br><img style="width: 376.00px" src="assets\cloud_storage_img_intro.png" onclick="imageclick(src)"></p>
...
<ul>
    ...
    </span><span class="str">            //Cloud Storage</span><span class="pln">
		implementation </span><span class="str">'com.huawei.agconnect:agconnect-storage: 1.3.0.300'</span><span class="pln">
		</span><span class="pun">...</span><span class="pln">
	</span><span class="pun">}</span><span class="pln">
	</span></code></pre>
  <p>For AGC Cloud Storage Service, please refer to <a href="https://developer.huawei.com/consumer/en/doc/development/AppGallery-connect-Guides/agc-cloudstorage-sdkchangenotes" target="_blank">latest version</a>.</p>
	</li>
